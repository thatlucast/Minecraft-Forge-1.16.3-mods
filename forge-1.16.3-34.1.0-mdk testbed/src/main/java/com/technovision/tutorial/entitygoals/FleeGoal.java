package com.technovision.tutorial.entitygoals;
...
public class FleeGoal<T extends LivingEntity> extends Goal {
   ...
   public FleeGoal(CreatureEntity entityIn, Class<T> avoidClass, float distance, double nearSpeedIn, double farSpeedIn, Predicate<LivingEntity> targetPredicate) {
   ...
   public boolean shouldExecute() {
      ...
      if (this.avoidTarget == null) {
         ...
         Vector3d vector3d = RandomPositionGenerator.findRandomTargetBlockAwayFrom(this.entity, 200, 250, this.avoidTarget.getPositionVec());
         if (vector3d == null) {
            return false;
